...
1. [x] Create an extract_title(markdown) function.
...
2. [ ] Write some unit tests for it.

3. [x] Create an HTML file called template.html in the root of your project. Use the content found at the bottom of this page.

4. [x] Create a content/index.md file. This is the main page of the site. Copy the contents from the bottom of this page.

5. [ ] Create a generate_page(from_path, template_path, dest_path) function. It should:
    1. [x] Print a message like "Generating page from from_path to dest_path using template_path".
    2. [x] Read the markdown file at from_path and store the contents in a variable.
    3. [x] Read the template file at template_path and store the contents in a variable.
...
8. [ ] Run the main.sh script, if everything goes well, you should be able to see your webpage at http://localhost:8888 in your browser! Keep in mind, none of the links will work, but the content should be there.

9. [ ] Inspect the page in your browser, as well as the raw HTML output. If you wrote really good unit tests, its likely that everything worked as expected. If you see any errors, debug and fix them!
...
- [x] Split the markdown into blocks (you already have a function for this)
